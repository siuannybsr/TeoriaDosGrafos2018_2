...
public class IndependentSet {
	public static void main(String[] args) {
		...
		EdgeProvider<Object, DefaultEdge> ep1 = (from, to, label, attributes) -> new DefaultEdge();
		...
		try {
			gmlImporter.importGraph(graphgml,
					ImportGraph.readFile("./files/cordal.gml"));
		} catch (ImportException e) {
			throw new RuntimeException(e);
		}

		ChordalGraphIndependentSetFinder<Object, DefaultEdge> is = new ChordalGraphIndependentSetFinder<>(graphgml);
		...
		ComplementGraphGenerator<Object, DefaultEdge> cGenerator = new ComplementGraphGenerator<>(graphgml);
		cGenerator.generateGraph(complement);
		PivotBronKerboschCliqueFinder<Object, DefaultEdge> cf3 = new PivotBronKerboschCliqueFinder<>(complement);
