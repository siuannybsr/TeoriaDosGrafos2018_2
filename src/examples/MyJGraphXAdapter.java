...
public class MyJGraphXAdapter extends JFrame {
	// Cria um grafo e representa em um frame grafico
	...
	MyJGraphXAdapter() {
		...
		ListenableGraph<Object, DefaultEdge> lgraph = new DefaultListenableGraph<>(createGraph());
