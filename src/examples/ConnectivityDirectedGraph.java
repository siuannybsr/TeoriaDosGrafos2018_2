...
public class ConnectivityDirectedGraph {
	...
	public static void main(String[] args) {
		...
		ConnectivityInspector<DefaultVertex, RelationshipDirectedEdge> k = new ConnectivityInspector<>(graphgml);
		...
		System.out.println("Paths from " + source + " to " + target + "? " + p.getAllPaths(source, target, true, null));
