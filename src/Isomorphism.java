...
public class Isomorphism {
	...
	public static void main(String[] args) {
	    ...
	    Graph<DefaultVertex, RelationshipEdge> g1 = new SimpleGraph<>(RelationshipEdge.class);
  	    try {
	        gmlImporter.importGraph(g1, ImportGraph.readFile(System.getProperty("user.dir") + "\\src\\K3-3.gml"));
	      } catch (ImportException e) {
	        throw new RuntimeException(e);
	      }	    
   	    System.out.println("Grafo G1: ");
	    System.out.println("Arestas: "+ g1.edgeSet());
	    System.out.println("Vértices: " + g1.vertexSet());
	    
	    //Import G2
	    Graph<DefaultVertex, RelationshipEdge> g2 = new SimpleGraph<>(RelationshipEdge.class);
  	    try {
	        gmlImporter.importGraph(g2, ImportGraph.readFile("C:\\Users\\patricia\\Dropbox\\workspace\\Graph Theory\\src\\K3-3-Isomorfico.gml"));
	      } catch (ImportException e) {
	        throw new RuntimeException(e);
	      }	    
   	    System.out.println("\nGrafo G2: ");
	    System.out.println("Arestas: "+ g2.edgeSet());
	    System.out.println("Vértices: " + g2.vertexSet());
	    
	    //Import G3
	    Graph<DefaultVertex, RelationshipEdge> g3 = new SimpleGraph<>(RelationshipEdge.class);
  	    try {
	        gmlImporter.importGraph(g3, ImportGraph.readFile("C:\\Users\\patricia\\Dropbox\\workspace\\Graph Theory\\src\\cubo-rotulado.gml"));
	      } catch (ImportException e) {
	        throw new RuntimeException(e);
	      }	    
   	    System.out.println("\nGrafo G3: ");
	    System.out.println("Arestas: "+ g3.edgeSet());
	    System.out.println("Vértices: " + g3.vertexSet());
	    
	    //Import G4
	    Graph<DefaultVertex, RelationshipEdge> g4 = new SimpleGraph<>(RelationshipEdge.class);
  	    try {
	        gmlImporter.importGraph(g4, ImportGraph.readFile("C:\\Users\\patricia\\Dropbox\\workspace\\Graph Theory\\src\\nao-isomorficocubo.gml"));
	      } catch (ImportException e) {
	        throw new RuntimeException(e);
	      }	    
   	    System.out.println("\nGrafo G4: ");
	    System.out.println("Arestas: "+ g4.edgeSet());
	    System.out.println("Vértices: " + g4.vertexSet());
	    
	    //Import Petersen
	    Graph<DefaultVertex, RelationshipEdge> p = new SimpleGraph<>(RelationshipEdge.class);
  	    try {
	        gmlImporter.importGraph(p, ImportGraph.readFile("C:\\Users\\patricia\\Dropbox\\workspace\\Graph Theory\\src\\petersen-labelled.gml"));
	      } catch (ImportException e) {
	        throw new RuntimeException(e);
	      }	    
   	    System.out.println("\nGrafo de Petersen: ");
	    System.out.println("Arestas: "+ p.edgeSet());
	    System.out.println("Vértices: " + p.vertexSet());
