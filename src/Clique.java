...
public class Clique {
	...
	public static void main(String[] args) {
		...
		EdgeProvider<Object, RelationshipEdge> ep = (from, to, label, attributes) -> new RelationshipEdge(from, to, attributes);
		...
		DegeneracyBronKerboschCliqueFinder<Object, RelationshipEdge> cf2 = new DegeneracyBronKerboschCliqueFinder<>(graphgml);
